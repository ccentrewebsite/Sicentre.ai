...
const footerColumns = [
  ...
  },
  {
    title: "Contacto",
    links: [
      { label: "hola@sicentre.com", href: "mailto:hola@sicentre.com" },
...
export default function FooterSection() {
  return (
    <footer className="relative px-4 md:px-8 pb-6 pt-2">
      {/* Liquid glass container */}
      <div className="relative overflow-hidden rounded-3xl" style={{ isolation: "isolate" }}>

        {/* Layer 1 — backdrop glass */}
        <div
          className="absolute inset-0"
          style={{
            backdropFilter: "blur(40px) saturate(160%) brightness(0.65)",
            WebkitBackdropFilter: "blur(40px) saturate(160%) brightness(0.65)",
            background: "rgba(0,0,0,0.6)",
          }}
        />

        {/* Layer 2 — tint sombre + bordures refraction */}
        <div
          className="absolute inset-0 pointer-events-none rounded-3xl"
          style={{
            background:
              "linear-gradient(160deg, rgba(255,255,255,0.05) 0%, rgba(124,58,237,0.04) 40%, rgba(0,0,0,0.1) 100%)",
            border: "1px solid rgba(255,255,255,0.09)",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,0.13), inset 0 -1px 0 rgba(0,0,0,0.35), 0 -8px 40px rgba(0,0,0,0.45)",
          }}
        />

        {/* Layer 3 — ligne de refraction en haut */}
        <div
          className="absolute top-0 left-[4%] right-[4%] h-px pointer-events-none"
          style={{
            background:
              "linear-gradient(90deg, transparent, rgba(255,255,255,0.28) 25%, rgba(255,255,255,0.10) 75%, transparent)",
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="py-12 md:py-16 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-8">
            ...
            <div className="col-span-2 md:col-span-2 lg:col-span-1 flex flex-col gap-5">
              ...
              <div className="flex items-center gap-3">
                <a
                  href="https://instagram.com/sicentre"
                  target="_blank"
                ...
                <a
                  href="https://linkedin.com/company/sicentre"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-violet-500/50 transition-all duration-200"
                  aria-label="LinkedIn"
          ...
          <div className="border-t border-white/[0.07] py-6 flex flex-col md:flex-row items-center justify-between gap-3">
            <p className="text-white/30 text-sm text-center md:text-left">
              © 2026 Sicentre. Todos los derechos reservados · Asunción, Paraguay
            </p>
