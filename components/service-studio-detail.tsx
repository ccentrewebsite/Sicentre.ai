    ...
    <section ref={sectionRef} className="relative py-24 overflow-hidden planet-section">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10">
        ...
        <div className={cn("text-center mb-12 md:mb-14 transition-all duration-700", visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6")}>
          ...
          >
            Fotografía editorial. Video cinematográfico. Contenido mensual.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ gridAutoRows: "minmax(280px, auto)" }}>
          ...
          <div
            ...
            style={{
              ...
              minHeight: "280px",
              background: "linear-gradient(135deg, rgba(124,58,237,0.28) 0%, rgba(234,88,12,0.20) 100%)",
              boxShadow: "0 16px 60px rgba(124,58,237,0.25), 0 0 70px rgba(234,88,12,0.18), inset 0 0 40px rgba(255,255,255,0.04)",
            }}
          >
            <div>
              <p
              ...
              >
                Producción mensual hecha a su medida.
              </h3>
              <p className="text-white/75 text-sm leading-relaxed">
                Vea cada formato, frecuencia y opción de producción que armamos para su marca.
              </p>
            </div>
            <Link
              href="/motion"
